...
public class Main extends TelegramLongPollingBot {
    ...
    public String getBotUsername() {
        return "BanderogusGoitBotKushnir_bot";
    }
    @Override
    public String getBotToken() {
        return "6035041708:AAFemK5OCTOE326RoZIPM61tZUylMq4bzKI";
    }
...
//                    send image
                    ...
                    message.setChatId(chatId);
                    attachButtons(message, Map.of(
                            "Злітати на тестовий рейд по чотирьох позиціях (+15 монет)", "level_2_task",
                            "Відвезти гуманітарку на передок (+15 монет)", "level_2_task",
                            "Знайти зрадника та здати в СБУ (+15 монет)", "level_2_task"
                    ));
                    sendApiMethodAsync(message);
                }
...
//        }
    ...
    public SendMessage createMassage (String text) {
        ...
        massage.setText(new String(text.getBytes(), StandardCharsets.UTF_8));
        massage.setParseMode("markdown");
        return massage;
